...
create table log_sistema (id integer not null auto_increment, comando varchar(255), datagravacao datetime, email_usuario varchar(255), status bit, empresa_id integer not null, pedido_id integer not null, produto_id integer not null, tenant_id integer, usuario_id integer not null, primary key (id)) engine=InnoDB;
